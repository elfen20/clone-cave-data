...
{
    /// <summary>
    /// Provides an interface for field properties.
    /// </summary>
    public interface IFieldProperties : IEquatable<IFieldProperties>
    {
        ...
        /// <summary>
        /// Gets a value indicating whether the field may contain null.
        /// </summary>
        bool IsNullable { get; }
        ...
        /// <summary>
        /// Gets the date time kind used at the database.
        /// </summary>
        DateTimeKind DateTimeKind { get; }

        /// <summary>
        /// Gets the date time type used at the database (has to match the <see cref="TypeAtDatabase"/>).
        /// </summary>
        ...
        /// <summary>
        /// Gets the format arguments for displaying values.
        /// </summary>
        ...
        /// <summary>
        /// Creates a copy for editing properties.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves a string for the specified value. The string may be parsed back to a value using <see cref="ParseValue(string, string, IFormatProvider)" />.
        /// </summary>
