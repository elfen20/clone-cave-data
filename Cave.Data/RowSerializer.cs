...
namespace Cave.Data
{
    ...
    public static partial class RowSerializer
    {
        ...
        static void SerializeData(DataWriter writer, RowLayout layout, Row row)
        {
            ...
            {
                DataType dataType = layout[i].DataType;
                switch (dataType)
                {
                    ...
                    case DataType.Bool: writer.Write((bool)row[i]); break;
                    case DataType.TimeSpan: writer.Write((TimeSpan)row[i]); break;
                    case DataType.DateTime: writer.Write((DateTime)row[i]); break;
                    case DataType.Single: writer.Write((float)row[i]); break;
                    case DataType.Double: writer.Write((double)row[i]); break;
                    case DataType.Int8: writer.Write((sbyte)row[i]); break;
                    case DataType.Int16: writer.Write((short)row[i]); break;
                    case DataType.UInt8: writer.Write((byte)row[i]); break;
                    case DataType.UInt16: writer.Write((ushort)row[i]); break;
                    case DataType.Int32: writer.Write7BitEncoded32((int)row[i]); break;
                    case DataType.Int64: writer.Write7BitEncoded64((long)row[i]); break;
                    case DataType.UInt32: writer.Write7BitEncoded32((uint)row[i]); break;
                    case DataType.UInt64: writer.Write7BitEncoded64((ulong)row[i]); break;
                    case DataType.Char: writer.Write((char)row[i]); break;
                    case DataType.Decimal: writer.Write((decimal)row[i]); break;
        ...
        static Row DeserializeData(DataReader reader, RowLayout layout)
        {
            ...
            for (var i = 0; i < layout.FieldCount; i++)
            {
                ...
                switch (dataType)
                {
                    ...
                    case DataType.DateTime: values[i] = reader.ReadDateTime(); break;
                    case DataType.TimeSpan: values[i] = reader.ReadTimeSpan(); break;
                    case DataType.Int8: values[i] = reader.ReadInt8(); break;
                    case DataType.Int16: values[i] = reader.ReadInt16(); break;
                    case DataType.Int32: values[i] = reader.Read7BitEncodedInt32(); break;
                    case DataType.Int64: values[i] = reader.Read7BitEncodedInt64(); break;
                    case DataType.UInt32: values[i] = reader.Read7BitEncodedUInt32(); break;
                    case DataType.UInt64: values[i] = reader.Read7BitEncodedUInt64(); break;
                    ...
                    case DataType.Enum: values[i] = reader.Read7BitEncodedInt64(); break;
                    case DataType.User: values[i] = reader.ReadString(); break;
