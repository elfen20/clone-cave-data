...
namespace Cave.Data
{
        ...
        where T : struct
    {
        ...
        {
            var newCache = new MemoryTable<T>();
        ...
        public override T GetStructAt(int index)
        {
            lock (this)
            {
                return cacheTable.GetStructAt(index);
            }
        }
        ...
        public override T GetStruct(long id)
        {
            lock (this)
            {
                return cacheTable.GetStruct(id);
            }
        }
        ...
        public override IList<T> GetStructs(IEnumerable<long> ids)
        {
            lock (this)
            {
                return cacheTable.GetStructs(ids);
            }
        }
