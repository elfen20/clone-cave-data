...
namespace Cave.Data
{
    ...
    {
        /// <summary>
        /// Gets the table name comparison type.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether the database was already closed or not.
        /// </summary>
        bool IsClosed { get; }
        ...
        /// <summary>
        /// Gets a value indicating whether the specified table exists or not.
        /// </summary>
        /// <param name="tableName">The name of the table.</param>
